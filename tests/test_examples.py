...
assert_that_stdout = {
    "patrol_workflow.yaml": [
        ...
        lambda out: "widget_type='stat', title='Average Speed'" in out,
        lambda out: "widget_type='stat', title='Max Speed'" in out,
    ],
    "mode-map.yaml": [
    ...
    "subject_tracking.yaml": [
        ...
        lambda out: "widget_type='stat', title='Mean Speed'" in out,
        lambda out: "widget_type='stat', title='Max Speed'," in out,
        lambda out: "widget_type='stat', title='Number of Locations'" in out,
