...
from ecoscope_workflows.core.annotations import DataFrame
from ecoscope_workflows.core.connections import is_client
...
def test_connection_named_from_toml(mock_toml_config: Path):
    with patch("ecoscope_workflows.core.config.PATH", mock_toml_config):
...
def test_connection_named_from_toml_with_env_secrets(mock_toml_config_no_secrets: Path):
    with patch.dict(os.environ, clear=True):
        with patch("ecoscope_workflows.core.config.PATH", mock_toml_config_no_secrets):
